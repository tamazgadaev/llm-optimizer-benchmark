...
# Explicitly use GPUs 0-3 to avoid issues with GPU 7
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 ./src/main.py --config_format base --model llama --distributed_backend nccl \
...
# micromamba activate llmopt-py310